...
package ys.components.focus {
	 ...
	 *  ys.components.focus.IFocusManagerComponent interface. Objects for which Flash Player
	...
	public class FocusManager implements IFocusManager {
		...
		/**
		 *  @copy ys.components.focus.IFocusManager#defaultButtonEnabled
         *
         * @langversion 3.0
         * @playerversion Flash 9.0.28.0
		 *  
