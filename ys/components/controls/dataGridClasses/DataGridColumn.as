package ys.components.controls.dataGridClasses {
	import ys.components.controls.YDataGrid;
	import ys.components.controls.listClasses.ICellRenderer;
	import ys.components.core.InvalidationType;
	import ys.components.controls.dataGridClasses.DataGridCellEditor;
     ...
     *
     * @see ys.components.controls.DataGrid
     *
	...
	public class DataGridColumn	{
         ...
         * @playerversion Flash 9.0.28.0
		 */
		public var owner:YDataGrid; // mx_internal
         ...
         *
		 *  @default "ys.components.controls.dataGridClasses.DataGridCellEditor"
         *
		 ...
		 *  @productversion Flash CS3
		 */
		public var itemEditor:Object = "ys.components.controls.dataGridClasses.DataGridCellEditor";
		 ...
		 *  YTextInput, so the default value of the <code>editorDataField</code> 
		 *  property is <code>"text"</code>. This value specifies the 
		 *  <code>text</code> property of the YTextInput component.</p>
         *
         *  @default "text"
         *
         * @langversion 3.0
